// $ANTLR 3.5.1 myC.g 2014-05-02 10:23:51
...
public class myCParser extends Parser {
	...
	// $ANTLR start "program"
	// myC.g:16:1: program : MAIN S_L S_R B_L declarations statements B_R ;
	public final void program() throws RecognitionException {
		try {
			// myC.g:16:8: ( MAIN S_L S_R B_L declarations statements B_R )
			// myC.g:16:11: MAIN S_L S_R B_L declarations statements B_R
			{
	...
	// myC.g:19:1: declarations : ( type Identifier ';' declarations | type Identifier '=' arith_expression ';' declarations |);
	public final void declarations() throws RecognitionException {
		try {
			// myC.g:19:13: ( type Identifier ';' declarations | type Identifier '=' arith_expression ';' declarations |)
			int alt1=3;
			switch ( input.LA(1) ) {
			case INT_TYPE:
				{
			...
			switch (alt1) {
				case 1 :
					// myC.g:19:14: type Identifier ';' declarations
					{
					...
					break;
				case 2 :
					// myC.g:21:14: type Identifier '=' arith_expression ';' declarations
					{
	...
	// $ANTLR start "type"
	// myC.g:27:1: type : ( INT_TYPE | FLOAT_TYPE | CHAR_TYPE | DOUBLE_TYPE | INT_TYPE '*' | CHAR_TYPE '*' );
	public final void type() throws RecognitionException {
		try {
			// myC.g:27:5: ( INT_TYPE | FLOAT_TYPE | CHAR_TYPE | DOUBLE_TYPE | INT_TYPE '*' | CHAR_TYPE '*' )
			int alt2=6;
			switch ( input.LA(1) ) {
			case INT_TYPE:
				{
	...
	// myC.g:33:1: statements : ( statement statements |);
	public final void statements() throws RecognitionException {
		try {
			// myC.g:33:11: ( statement statements |)
			int alt3=2;
			...
			switch (alt3) {
				case 1 :
					// myC.g:33:12: statement statements
					{
	...
	public final void statement() throws RecognitionException {
		try {
			...
			switch (alt4) {
				case 1 :
					// myC.g:36:11: Identifier EXTRA8 arith_expression ';'
					{
					...
					break;
				case 2 :
					// myC.g:39:5: Identifier TOTALEO Identifier ';'
					{
					...
					break;
				case 3 :
					// myC.g:40:5: Identifier TOTALEO Integer_constant ';'
					{
					...
					break;
				case 4 :
					// myC.g:41:5: Identifier TOTALEO Identifier
					{
					...
					break;
				case 5 :
					// myC.g:42:5: Identifier TOTALEO Integer_constant
					{
				...
				case 7 :
					...
					break;
				case 8 :
					// myC.g:45:5: Identifier EXTRA8 Identifier CALCULATE Identifier ';'
					{
					...
					break;
				case 9 :
					// myC.g:46:5: Identifier CALCULATE Identifier TOTALEO Integer_constant
					{
				...
				case 11 :
					...
					break;
				case 12 :
					// myC.g:51:5: FOR S_L statements S_R B_L declarations statements B_R
					{
					...
					break;
				case 13 :
					// myC.g:53:5: WHILE S_L statements S_R B_L declarations statements B_R
					{
					...
					break;
				case 14 :
					// myC.g:55:5: PRINTF S_L EXTRA13 primary_expression EXTRA13 S_R ';'
					{
					...
					break;
				case 15 :
					// myC.g:57:5: IF_ S_L statements S_R B_L declarations statements B_R
					{
					...
					break;
				case 16 :
					// myC.g:59:5: ELSE IF_ S_L statements S_R B_L declarations statements B_R
					{
					...
					break;
				case 17 :
					// myC.g:61:5: ELSE B_L declarations statements B_R
					{
					...
					break;
				case 18 :
					// myC.g:63:5: RETURN Integer_constant ';'
					{
	...
	// myC.g:66:1: arith_expression : arith_term arith_expression1 ;
	public final void arith_expression() throws RecognitionException {
		try {
			// myC.g:66:17: ( arith_term arith_expression1 )
			// myC.g:66:18: arith_term arith_expression1
			{
	...
	// myC.g:67:1: arith_expression1 : ( '+' arith_term arith_expression1 | '-' arith_term arith_expression1 |);
	public final void arith_expression1() throws RecognitionException {
		try {
			// myC.g:67:18: ( '+' arith_term arith_expression1 | '-' arith_term arith_expression1 |)
			int alt5=3;
			switch ( input.LA(1) ) {
			case EO9:
				{
			...
			switch (alt5) {
				case 1 :
					// myC.g:67:19: '+' arith_term arith_expression1
					{
					...
					break;
				case 2 :
					// myC.g:68:19: '-' arith_term arith_expression1
					{
	...
	// myC.g:71:1: arith_term : arith_factor arith_term1 ;
	public final void arith_term() throws RecognitionException {
		try {
			// myC.g:71:11: ( arith_factor arith_term1 )
			// myC.g:71:12: arith_factor arith_term1
			{
	...
	// myC.g:72:1: arith_term1 : ( '*' arith_factor arith_term1 | '/' arith_factor arith_term1 |);
	public final void arith_term1() throws RecognitionException {
		try {
			// myC.g:72:12: ( '*' arith_factor arith_term1 | '/' arith_factor arith_term1 |)
			int alt6=3;
			switch ( input.LA(1) ) {
			case EO11:
				{
			...
			switch (alt6) {
				case 1 :
					// myC.g:72:13: '*' arith_factor arith_term1
					{
					...
					break;
				case 2 :
					// myC.g:73:13: '/' arith_factor arith_term1
					{
	...
	// myC.g:76:1: arith_factor : ( '+' arith_factor | '-' arith_factor | primary_expression );
	public final void arith_factor() throws RecognitionException {
		try {
			// myC.g:76:13: ( '+' arith_factor | '-' arith_factor | primary_expression )
			int alt7=3;
			switch ( input.LA(1) ) {
			case EO9:
				{
			...
			switch (alt7) {
				...
				case 2 :
					...
					break;
				case 3 :
					// myC.g:78:14: primary_expression
					{
	...
	// myC.g:80:1: primary_expression : ( Integer_constant primary_expression | Floating_point_constant primary_expression | Identifier primary_expression | Integer_constant | Floating_point_constant | Identifier );
	public final void primary_expression() throws RecognitionException {
		try {
			// myC.g:80:19: ( Integer_constant primary_expression | Floating_point_constant primary_expression | Identifier primary_expression | Integer_constant | Floating_point_constant | Identifier )
			int alt8=6;
			switch ( input.LA(1) ) {
			case Integer_constant:
				{
			...
			switch (alt8) {
				case 1 :
					// myC.g:80:20: Integer_constant primary_expression
					{
					...
					break;
				case 2 :
					// myC.g:81:20: Floating_point_constant primary_expression
					{
					...
					break;
				case 3 :
					// myC.g:82:20: Identifier primary_expression
					{
