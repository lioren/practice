...
public class myCLexer extends Lexer {
	...
	public myCLexer(CharStream input, RecognizerSharedState state) {
		super(input,state);
	}
	...
	public final void mCONTINUE() throws RecognitionException {
		try {
			int _type = CONTINUE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:104:11: ( 'continue' )
			// myC.g:104:13: 'continue'
			{
			match("continue"); 
	...
	public final void mDEFAULT() throws RecognitionException {
		try {
			int _type = DEFAULT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:108:11: ( 'default' )
			// myC.g:108:13: 'default'
			{
			match("default"); 
	...
	public final void mTYPEDEF() throws RecognitionException {
		try {
			int _type = TYPEDEF;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:111:11: ( 'typedef' )
			// myC.g:111:13: 'typedef'
			{
			match("typedef"); 
	...
	public final void mUNSIGNED() throws RecognitionException {
		try {
			int _type = UNSIGNED;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:113:11: ( 'unsigned' )
			// myC.g:113:13: 'unsigned'
			{
			match("unsigned"); 
	...
	public final void mTOTALEO() throws RecognitionException {
		try {
			int _type = TOTALEO;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:127:9: ( ( EQ_OP | LE_OP | GE_OP | LE2_OP | GE2_OP | NE_OP | PP_OP | MM_OP | EO1 | EO2 | EO5 | EO6 | EO7 )* )
			// myC.g:127:11: ( EQ_OP | LE_OP | GE_OP | LE2_OP | GE2_OP | NE_OP | PP_OP | MM_OP | EO1 | EO2 | EO5 | EO6 | EO7 )*
			{
			// myC.g:127:11: ( EQ_OP | LE_OP | GE_OP | LE2_OP | GE2_OP | NE_OP | PP_OP | MM_OP | EO1 | EO2 | EO5 | EO6 | EO7 )*
			loop1:
			while (true) {
	...
	public final void mCALCULATE() throws RecognitionException {
		try {
			int _type = CALCULATE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:141:10: ( ( EO9 | EO10 | EO11 | EO12 )+ )
			// myC.g:141:12: ( EO9 | EO10 | EO11 | EO12 )+
			{
			// myC.g:141:12: ( EO9 | EO10 | EO11 | EO12 )+
			int cnt2=0;
			loop2:
	...
	public final void mCOMMENT2() throws RecognitionException {
		try {
			int _type = COMMENT2;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:161:10: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// myC.g:161:12: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// myC.g:161:17: ( options {greedy=false; } : . )*
			loop4:
			while (true) {
				int alt4=2;
	...
	public final void mIdentifier() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:163:11: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			// myC.g:163:12: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
	...
	public final void mFloating_point_constant() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:166:24: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )+ )
			// myC.g:166:25: ( '0' .. '9' )+ '.' ( '0' .. '9' )+
			{
			// myC.g:166:25: ( '0' .. '9' )+
			int cnt7=0;
			loop7:
	...
	public final void mLETTER() throws RecognitionException {
		try {
			// myC.g:171:17: ( ( 'a' .. 'z' | 'A' .. 'Z' )+ )
			// myC.g:171:19: ( 'a' .. 'z' | 'A' .. 'Z' )+
			{
			// myC.g:171:19: ( 'a' .. 'z' | 'A' .. 'Z' )+
			int cnt9=0;
			loop9:
	...
	public void mTokens() throws RecognitionException {
		...
		switch (alt10) {
			...
			case 35 :
				...
				break;
			case 36 :
				// myC.g:1:281: Floating_point_constant
				{
