// $ANTLR 3.5.1 myC.g 2014-05-23 19:15:36
...
public class myCParser extends Parser {
	...
	public myCParser(TokenStream input, RecognizerSharedState state) {
		super(input, state);
	}

	@Override public String[] getTokenNames() { return myCParser.tokenNames; }
	@Override public String getGrammarFileName() { return "myC.g"; }
	...
	// $ANTLR start "program"
	// myC.g:18:1: program : MAIN S_L S_R B_L declarations statements B_R ;
	public final void program() throws RecognitionException {
		try {
			// myC.g:18:8: ( MAIN S_L S_R B_L declarations statements B_R )
			// myC.g:18:11: MAIN S_L S_R B_L declarations statements B_R
			{
	...
	// myC.g:21:1: declarations : ( type Identifier ';' declarations | type Identifier '=' arith_expression ';' declarations |);
	public final void declarations() throws RecognitionException {
		...
		try {
			// myC.g:21:13: ( type Identifier ';' declarations | type Identifier '=' arith_expression ';' declarations |)
			int alt1=3;
			switch ( input.LA(1) ) {
			case INT_TYPE:
				{
			...
			switch (alt1) {
				case 1 :
					// myC.g:21:14: type Identifier ';' declarations
					{
					...
					break;
				case 2 :
					// myC.g:29:14: type Identifier '=' arith_expression ';' declarations
					{
	...
	// $ANTLR start "type"
	// myC.g:39:1: type returns [int attr_type] : ( INT_TYPE | FLOAT_TYPE | CHAR_TYPE | DOUBLE_TYPE | INT_TYPE '*' | CHAR_TYPE '*' );
	public final int type() throws RecognitionException {
		int attr_type = 0;


		try {
			// myC.g:39:29: ( INT_TYPE | FLOAT_TYPE | CHAR_TYPE | DOUBLE_TYPE | INT_TYPE '*' | CHAR_TYPE '*' )
			int alt2=6;
			switch ( input.LA(1) ) {
			case INT_TYPE:
				{
	...
	// myC.g:47:1: statements : ( statement statements |);
	public final void statements() throws RecognitionException {
		try {
			// myC.g:47:11: ( statement statements |)
			int alt3=2;
			...
			switch (alt3) {
				case 1 :
					// myC.g:47:12: statement statements
					{
	...
	public final int statement() throws RecognitionException {
		...
		try {
			// myC.g:51:5: ( Identifier '=' arith_expression ';' | Identifier TOTALEO Identifier ';' | Identifier TOTALEO Integer_constant ';' | Identifier TOTALEO Identifier | Identifier TOTALEO Integer_constant | Identifier TOTALEO | Identifier TOTALEO ';' | BREAK ';' | CONTINUE ';' | FOR S_L statements S_R B_L declarations statements B_R | WHILE S_L statements S_R B_L declarations statements B_R | PRINTF S_L EXTRA13 primary_expression EXTRA13 S_R ';' | IF_ S_L statements S_R B_L declarations statements B_R | ELSE IF_ S_L statements S_R B_L declarations statements B_R | ELSE B_L declarations statements B_R | RETURN Integer_constant ';' )
			int alt4=16;
			switch ( input.LA(1) ) {
			case Identifier:
				{
			...
			switch (alt4) {
				case 1 :
					// myC.g:52:5: Identifier '=' arith_expression ';'
					{
					...
					match(input,EXTRA10,FOLLOW_EXTRA10_in_statement248); 
					 if (TRACEON) System.out.println("Assign value");
						   		...
						   		if (attr_type != (arith_expression6!=null?((myCParser.arith_expression_return)arith_expression6).attr_type:0)) {
					...
					break;
				case 2 :
					// myC.g:70:5: Identifier TOTALEO Identifier ';'
					{
					...
					break;
				case 3 :
					// myC.g:71:5: Identifier TOTALEO Integer_constant ';'
					{
					...
					break;
				case 4 :
					// myC.g:72:5: Identifier TOTALEO Identifier
					{
					...
					break;
				case 5 :
					// myC.g:73:5: Identifier TOTALEO Integer_constant
					{
				...
				case 9 :
					...
					break;
				case 10 :
					// myC.g:81:5: FOR S_L statements S_R B_L declarations statements B_R
					{
					...
					break;
				case 11 :
					// myC.g:83:5: WHILE S_L statements S_R B_L declarations statements B_R
					{
					...
					break;
				case 12 :
					// myC.g:85:5: PRINTF S_L EXTRA13 primary_expression EXTRA13 S_R ';'
					{
					...
					break;
				case 13 :
					// myC.g:87:5: IF_ S_L statements S_R B_L declarations statements B_R
					{
					...
					break;
				case 14 :
					// myC.g:89:5: ELSE IF_ S_L statements S_R B_L declarations statements B_R
					{
					...
					break;
				case 15 :
					// myC.g:91:5: ELSE B_L declarations statements B_R
					{
					...
					break;
				case 16 :
					// myC.g:93:5: RETURN Integer_constant ';'
					{
	...
	// myC.g:101:1: arith_expression returns [int attr_type] : a= arith_term ( '+' b= arith_term | '-' c= arith_term )* ;
	public final myCParser.arith_expression_return arith_expression() throws RecognitionException {
		myCParser.arith_expression_return retval = new myCParser.arith_expression_return();
		...
		try {
			// myC.g:101:41: (a= arith_term ( '+' b= arith_term | '-' c= arith_term )* )
			// myC.g:102:2: a= arith_term ( '+' b= arith_term | '-' c= arith_term )*
			{
			pushFollow(FOLLOW_arith_term_in_arith_expression532);
			a=arith_term();
			state._fsp--;

			 retval.attr_type = (a!=null?((myCParser.arith_term_return)a).attr_type:0); 
			// myC.g:103:7: ( '+' b= arith_term | '-' c= arith_term )*
			loop5:
			while (true) {
				int alt5=3;
				...
				case 1 :
					...
					state._fsp--;
					 ...
					 if ((a!=null?((myCParser.arith_term_return)a).attr_type:0) != (b!=null?((myCParser.arith_term_return)b).attr_type:0)) {
								  System.out.println("Type Error: " + 
				...
				case 2 :
					...
					state._fsp--;
					 ...
					 if ((a!=null?((myCParser.arith_term_return)a).attr_type:0) != (c!=null?((myCParser.arith_term_return)c).attr_type:0)) {
										  System.out.println("Type Error: " + 
															 (a!=null?(a.start):null).getLine() +
															 ": Type mismatch for the operator - in an expression.");
										  retval.attr_type = -2;
	...
	// myC.g:122:3: arith_term returns [int attr_type] : a= arith_factor ( '*' b= arith_factor | '/' c= arith_factor )* ;
	public final myCParser.arith_term_return arith_term() throws RecognitionException {
		myCParser.arith_term_return retval = new myCParser.arith_term_return();
		retval.start = input.LT(1);
		...
		try {
			// myC.g:122:37: (a= arith_factor ( '*' b= arith_factor | '/' c= arith_factor )* )
			// myC.g:123:5: a= arith_factor ( '*' b= arith_factor | '/' c= arith_factor )*
			{
			pushFollow(FOLLOW_arith_factor_in_arith_term612);
			a=arith_factor();
			state._fsp--;

			 retval.attr_type = (a!=null?((myCParser.arith_factor_return)a).attr_type:0); 
			// myC.g:124:6: ( '*' b= arith_factor | '/' c= arith_factor )*
			loop6:
			while (true) {
				int alt6=3;
				...
				case 1 :
					...
					if ((a!=null?((myCParser.arith_factor_return)a).attr_type:0) !=(b!=null?((myCParser.arith_factor_return)b).attr_type:0)){
				...
				case 2 :
					...
					if ((a!=null?((myCParser.arith_factor_return)a).attr_type:0) !=(c!=null?((myCParser.arith_factor_return)c).attr_type:0)){
					       		   System.out.println("Type Error: "+ (a!=null?(a.start):null).getLine() + ":Type mismatch for the operator / in an expression.");
					       		   retval.attr_type = -2;
						     }
	...
	// myC.g:144:1: arith_factor returns [int attr_type ] : ( primary_expression | '-' primary_expression );
	public final myCParser.arith_factor_return arith_factor() throws RecognitionException {
		myCParser.arith_factor_return retval = new myCParser.arith_factor_return();
		retval.start = input.LT(1);
		...
		try {
			// myC.g:144:38: ( primary_expression | '-' primary_expression )
			int alt7=2;
			...
			switch (alt7) {
				case 1 :
					// myC.g:145:4: primary_expression
					{
					...
					break;
				case 2 :
					// myC.g:146:13: '-' primary_expression
					{
	...
	// myC.g:148:1: primary_expression returns [int attr_type] : ( Integer_constant primary_expression | Floating_point_constant primary_expression | Identifier primary_expression | Integer_constant | Floating_point_constant | Identifier | '(' arith_expression ')' );
	public final int primary_expression() throws RecognitionException {
		...
		try {
			// myC.g:148:43: ( Integer_constant primary_expression | Floating_point_constant primary_expression | Identifier primary_expression | Integer_constant | Floating_point_constant | Identifier | '(' arith_expression ')' )
			int alt8=7;
			switch ( input.LA(1) ) {
			case Integer_constant:
				{
			...
			switch (alt8) {
				case 1 :
					// myC.g:149:8: Integer_constant primary_expression
					{
					...
					break;
				case 2 :
					// myC.g:150:20: Floating_point_constant primary_expression
					{
					...
					break;
				case 3 :
					// myC.g:151:20: Identifier primary_expression
					{
				...
				case 4 :
					...
					break;
				case 5 :
					// myC.g:153:20: Floating_point_constant
					{
				...
				case 7 :
					...
					attr_type =(arith_expression9!=null?((myCParser.arith_expression_return)arith_expression9).attr_type:0);
					}
					break;
