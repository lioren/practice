...
public class myCLexer extends Lexer {
	...
	public final void mCONTINUE() throws RecognitionException {
		try {
			int _type = CONTINUE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:174:11: ( 'continue' )
			// myC.g:174:13: 'continue'
			{
			match("continue"); 
	...
	public final void mDEFAULT() throws RecognitionException {
		try {
			int _type = DEFAULT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:178:11: ( 'default' )
			// myC.g:178:13: 'default'
			{
			match("default"); 
	...
	public final void mTYPEDEF() throws RecognitionException {
		try {
			int _type = TYPEDEF;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:181:11: ( 'typedef' )
			// myC.g:181:13: 'typedef'
			{
			match("typedef"); 
	...
	public final void mUNSIGNED() throws RecognitionException {
		try {
			int _type = UNSIGNED;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:183:11: ( 'unsigned' )
			// myC.g:183:13: 'unsigned'
			{
			match("unsigned"); 
	...
	public final void mTOTALEO() throws RecognitionException {
		try {
			int _type = TOTALEO;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:197:9: ( ( EQ_OP | LE_OP | GE_OP | LE2_OP | GE2_OP | NE_OP | PP_OP | MM_OP | EO1 | EO2 | EO5 | EO6 | EO7 )* )
			// myC.g:197:11: ( EQ_OP | LE_OP | GE_OP | LE2_OP | GE2_OP | NE_OP | PP_OP | MM_OP | EO1 | EO2 | EO5 | EO6 | EO7 )*
			{
			// myC.g:197:11: ( EQ_OP | LE_OP | GE_OP | LE2_OP | GE2_OP | NE_OP | PP_OP | MM_OP | EO1 | EO2 | EO5 | EO6 | EO7 )*
			loop1:
			while (true) {
	...
	public final void mCOMMENT2() throws RecognitionException {
		try {
			int _type = COMMENT2;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:231:10: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// myC.g:231:12: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// myC.g:231:17: ( options {greedy=false; } : . )*
			loop3:
			while (true) {
				int alt3=2;
	...
	public final void mIdentifier() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:233:11: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			// myC.g:233:12: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
	...
	public final void mFloating_point_constant() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC.g:236:24: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )+ )
			// myC.g:236:25: ( '0' .. '9' )+ '.' ( '0' .. '9' )+
			{
			// myC.g:236:25: ( '0' .. '9' )+
			int cnt6=0;
			loop6:
	...
	public final void mLETTER() throws RecognitionException {
		try {
			// myC.g:241:17: ( ( 'a' .. 'z' | 'A' .. 'Z' )+ )
			// myC.g:241:19: ( 'a' .. 'z' | 'A' .. 'Z' )+
			{
			// myC.g:241:19: ( 'a' .. 'z' | 'A' .. 'Z' )+
			int cnt8=0;
			loop8:
	...
	public void mTokens() throws RecognitionException {
		...
		switch (alt9) {
			...
			case 38 :
				...
				break;
			case 39 :
				// myC.g:1:295: Floating_point_constant
				{
